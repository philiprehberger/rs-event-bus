...
[![GitHub release](https://img.shields.io/github/v/release/philiprehberger/rs-event-bus)](https://github.com/philiprehberger/rs-event-bus/releases)
[![Last updated](https://img.shields.io/github/last-commit/philiprehberger/rs-event-bus)](https://github.com/philiprehberger/rs-event-bus/commits/main)
[![License](https://img.shields.io/github/license/philiprehberger/rs-event-bus)](LICENSE)
[![Bug Reports](https://img.shields.io/github/issues/philiprehberger/rs-event-bus/bug)](https://github.com/philiprehberger/rs-event-bus/issues?q=is%3Aissue+is%3Aopen+label%3Abug)
[![Feature Requests](https://img.shields.io/github/issues/philiprehberger/rs-event-bus/enhancement)](https://github.com/philiprehberger/rs-event-bus/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
...
```toml
[dependencies]
philiprehberger-event-bus = "0.2.4"
```
